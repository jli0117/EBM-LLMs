...
Four tasks in evidence-based medicine is adopted in our code, incluing PICO extraction, biomedical question answering (QA), summarizing randomized controlled trials, and medical text simplification.
