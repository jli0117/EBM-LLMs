...
You can modify the parameters in the corresponding jupyter notebook to get results. `GPT` for changing different large language models, and `prompt_type` for changing the prompgintg styles, including `base`, `1-shot`
