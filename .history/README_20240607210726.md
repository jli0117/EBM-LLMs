...
You can modify the parameters in the corresponding jupyter notebook to get results in the `params` dictionary within the main function. Expand `params_list` to include multiple hyperparameter configurations for grid search.
